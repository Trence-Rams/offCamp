...
const SettingsComponent = () => {
    ...
    return (
        ...
        <View style={{ gap: 5, marginHorizontal: 20}}>
            <Text style={{ padding: 15,fontWeight:'bold',fontSize:15 }}>Settings</Text>

            <TouchableOpacity onPress={showAlert} style={{ backgroundColor: "#fff", padding: 5, borderRadius: 5 }}>
            ...
            <TouchableOpacity onPress={() => setShowEmailEditModal(true)} style={{ backgroundColor: "#fff", padding: 5, borderRadius: 5 }}>
                <View style={{ flexDirection: "row", gap: 10, marginRight: "50%", paddingVertical: 10 }}>
            ...
            <TouchableOpacity  onPress={() => setShowPasswordEditModal(true)} style={{ backgroundColor: "#fff", padding: 5, borderRadius: 5 }}>
                <View style={{ flexDirection: "row", gap: 10, marginRight: "50%", paddingVertical: 10 }}>
            ...
            <TouchableOpacity onPress={() => setShowUserNameEditModal(true)} style={{ backgroundColor: "#fff", padding: 5, borderRadius: 5 }}>
                <View style={{ flexDirection: "row", gap: 10, marginRight: "50%", paddingVertical: 10 }}>
            ...
            <TouchableOpacity  onPress={() => setShowContactEditModal(true)} style={{ backgroundColor: "#fff", padding: 5, borderRadius: 5 }}>
                <View style={{ flexDirection: "row", gap: 10, marginRight: "50%", paddingVertical: 10 }}>
                ...
                >
                 <View style={styles.content}>
                    ...
                    <View style={{alignItems:'center',width:'100%'}}>
                        <Button
                        title="Continue"
                        buttonStyle={{ backgroundColor: '#fc8e53', width: 200, borderRadius: 20,marginBottom:20}}
                        />
                        <Button
                        onPress={() => setShowDeleteModal(false)}
                        title="cancel"
                        buttonStyle={{ backgroundColor: '#adadad', width: 200, borderRadius: 20,marginBottom:20}}
                        />
                    </View>
                 </View>
